...
function Income(){
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/categories`).then((response) => {
    ...
    const handleCreate = async (inputValue) => {
        ...
        setTimeout(async() => {
            ...
            setIsLoading(false);
            try{
                axios.post(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/categories`, {
            ...
            // const request = await fetch(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/categories`, {
            // method: 'POST',
            // headers: {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/income`).then((response) => {
    ...
    const postIncome= async (e) => {
        ...
        try{
            ...
            axios.post(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/income`, {
                title: title,
    ...
    const handleEdit = async (e, id) => {
        e.preventDefault();
        try{
          axios.put(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/income/${id}`, {
            title: newTitle,
...
/***********************************************************************************************/
    ...
    const handleDelete = async (e, id) => {
        e.preventDefault();
        try{
            axios.delete(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/income/${id}`)
            .then((response) => {
                setRender(!render);
            })
        }catch(err){
