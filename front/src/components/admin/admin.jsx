...
function Admin() {
  ...
  useEffect(() => {
    const getAdmins = async () => {
      const response = await fetch(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/admins`, {
        method: "GET",
      });
  ...
  const handleClick = async (e) => {
    e.preventDefault();
    const request = await fetch(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/register`, {
      method: "POST",
