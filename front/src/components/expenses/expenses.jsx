...
function Expenses(){
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/expenses`).then((response) => {
    ...
    const postExpenses= async (e) => {
        ...
        try{
            ...
            axios.post(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/expenses`, {
                title: title,
    ...
    const handleEdit = async (e, id) => {
        e.preventDefault();
        try{
          axios.put(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/expenses/${id}`, {
            title: newTitle,
...
/***********************************************************************************************/
    ...
    const handleDelete = async (e, id) => {
        e.preventDefault();
        try{
            axios.delete(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/expenses/${id}`)
            .then((response) => {
                setRender(!render);
            })
        }catch(err){
