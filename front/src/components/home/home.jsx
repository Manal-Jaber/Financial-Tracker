...
function Home(){
    ...
    useEffect(() => {
        const getData = (time)=>{
            axios.get(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/reports/${time}`).then((response) => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/goals/1`).then((response) => {
    ...
    const editGoal = async (e) => {
        ...
        try{
            axios.put(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/goals/1`, {
              yearly: test
            }).then((response) => {
                console.log('updated');
                setNewRangeGoal('');
