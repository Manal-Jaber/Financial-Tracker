...
function Categories(){
    ...
    const handleEdit = async (e, id) => {
        e.preventDefault();
        try{
          axios.put(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/categories/${id}`, {
      ...
      const handleDelete = async (e, id) => {
        e.preventDefault();
        try{
            axios.delete(`${process.env.REACT_APP_HOST}:${process.env.REACT_APP_PORT}/api/categories/${id}`)
            .then((response) => {
                console.log('deleted');
                setRender(!render);
            })
